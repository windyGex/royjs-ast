...
* [Store](#Store)
    ...
    * [.addState(name, value)](#Store+addState)
    * [.modify(name, content)](#Store+modify) ⇒
    * [.rename(oldName, newName)](#Store+rename) ⇒
    * [.add(name)](#Store+add) ⇒
    * [.modifyByStartEnd(node, content)](#Store+modifyByStartEnd) ⇒
...
<a name="Store+modifyByStartEnd"></a>
...
| content | <code>String</code> | 替换的content |
